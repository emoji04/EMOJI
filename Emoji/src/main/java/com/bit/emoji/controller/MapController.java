...
public class MapController {
	...
	public String insertReview(Model model, HttpServletRequest request, DeliciousMapReviewVO deliciousMapReviewVO) {
		...
		String deliciousMapGrade = request.getParameter("reviewGrade");
