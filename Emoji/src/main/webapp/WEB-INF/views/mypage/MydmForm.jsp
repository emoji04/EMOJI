...
<body>
	...
	<div id="all">
		...
		<div>
			<!-- <내 등록지도/ 내 관심지도 tap> -->
			<span id="tap_1" class="tap"><a href='<c:url value="MydmForm" />'>내 등록 지도 </a></span> 
			<span id="tap_2" class="tap"><a href='<c:url value="MydmForm" />'>내 관심 지도</a></span>
		</div>
		...
		<div id="myDmBox">
			...
			<div>
				<!-- 내 등록 지도 (전체선택란) -->
				<input type="checkbox">전체선택<input type="button" value="선택공개">
