...
<div id="right" style="position:relative;">
	...
	<div id="menu_wrap" class="bg_white" style="margin-top: 100px; height: 600px; position:absolute; ; left: 30px; border-radius: 0 0 0 0;">
	        <div class="option">
	            <div>
...
//////////////////////////////////////
		    ...
		    for ( var i=0; i<places.length; i++ ) {
		        ...
		        (function(marker, title) {
		            ...
		            itemEl.onclick = function (){
		            	console.log(title);
		            	$('#deliciousName').val(title);
		            	console.log(fragment);
		            	console.log(bounds);
		            	console.log(marker);
		            	console.log(itemEl);
		            	console.log($('#deliciousName').val(title));
		...
		function addMarker(position, idx, title) {
		    var imageSrc = 'http://t1.daumcdn.net/localimg/localimages/07/mapapidoc/marker_number_blue.png', // 마커 이미지 url, 스프라이트 이미지를 씁니다
		        imageSize = new daum.maps.Size(0, 0),  // 마커 이미지의 크기
		        imgOptions =  {
